        ...
        <div className="relative  mx-auto">
          ...
          <div className="grid grid-cols-1  gap-8 pt-16 ">
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-purple-400 group transform hover:-translate-y-2">
              <div className="flex items-center mb-6 gap-4">
                <div className="w-10 h-10 md:w-14 md:h-14 rounded group-hover:rotate-45 border-y-2 group-hover:border-purple-400 group-hover:rounded-full shadow-lg flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                  <Users className="w-5 h-5 md:w-8 md:h-8 text-black group-hover:text-purple-400 group-hover:-rotate-45" />
                </div>
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 justify-end text-end">Team</h2>
              </div>
              <p className="text-gray-700 text-base md:text-lg leading-relaxed">
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-400 group transform hover:-translate-y-2">
              <div className="flex items-center mb-6 gap-4">
                <div className="w-10 h-10 md:w-14 md:h-14  rounded group-hover:rotate-45 border-y-2 group-hover:border-blue-400 group-hover:rounded-full  shadow-lg flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                  <CheckSquare className="w-5 h-5 md:w-8 md:h-8 text-black group-hover:text-blue-400 group-hover:-rotate-45 " />
                </div>
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Task</h2>
              </div>
              <p className="text-gray-700 text-base md:text-lg leading-relaxed">
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-red-400 group transform hover:-translate-y-2">
              <div className="flex items-center mb-6 gap-4">
                <div className="w-10 h-10 md:w-14 md:h-14  rounded group-hover:rotate-45 border-y-2 group-hover:border-red-400 group-hover:rounded-full  shadow-lg flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                  <Calendar className="w-5 h-5 md:w-8 md:h-8 text-black group-hover:text-red-400 group-hover:-rotate-45" />
                </div>
